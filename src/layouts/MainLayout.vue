    ...
    <q-header elevated>
      <q-toolbar>
        ...
        <q-btn
          ...
          class="q-ma-xs"
        >
         <span class="tagalog title-letter">ᜏᜒ</span>
        </q-btn>

        <q-toolbar-title class="">
          <div class="">Virtual Vinodh</div>
        </q-toolbar-title>
...
@font-face {
  font-family: 'Telugu Codechart';
  src: url('../assets/telugu-codechart.otf')
}
...
.lopamudrasans {
  font-family: "Lopamudra Sans" !important;
  line-height: 1.6em;
}
.lopamudraserif {
